...
namespace LCG.Template.Client.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResult> Login(LoginModel loginModel)
        {
            ...
            var response = await _httpClient.PostAsync("api/v1/login", new StringContent(loginAsJson, Encoding.UTF8, "application/json"));
